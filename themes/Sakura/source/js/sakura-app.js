...
function nextBG() {
    $(".centerbg").css("background-image", 'url("https://feilongproject.github.io/img/' + Math.abs(bgn%8) + '.jpg")');
    bgn = bgn + 1;
}
...
$(document).ready(function () {
    $(".centerbg").css("background-image", 'url("https://feilongproject.github.io/img/' + bgn + '.jpg")');
...
function add_copyright() {
    ...
    function setClipboardText(event) {
        ...
        var htmlData = "" + "著作权归作者所有。<br>" + "商业转载请联系作者获得授权，非商业转载请注明出处。<br>" + "<br>" + "链接：" + window.location.href + "<br>" + "来源：" + mashiro_option.site_name + "<br>" + window.getSelection().toString().replace(/\r\n/g, "<br>");;
...
$(function () {
    ...
    console.log("%c 飞龙project %c", "background:#24272A; color:#ffffff", "", "https://feilongproject.github.io/");
